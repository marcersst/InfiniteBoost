...
import "../lib/openzeppelin-contracts/contracts/token/ERC20/IERC20.sol";
    ...
    contract BoosterVeloLpForkSegmentedTest is Test {
        ...
        function testUserDepositsWithIntervals() public {
            ...
            console.log("balance en ITP DESDE FUNCION", booster.earnedItp(user1, address(lpToken)));
            console.log("balance antes de reclamar itps:", itpToken.balanceOf(user1));
         ...
         */
            ...
            console.log("PORCENTAJE",booster.viewBoostPercentage(address(lpToken)));
            console.log("ISactive",booster.isActivePool(address(lpToken)));
            console.log("ISactive NO ACTIVE ",booster.isActivePool(address(0xA56a25Dee5B3199A9198Bbd48715EE3D0ed98378)));
